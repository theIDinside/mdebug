...
bool
JsonValue::IsBoolean(this auto &&self) noexcept
{
  return self.mType == Type::Boolean;
}

bool
JsonValue::IsString(this auto &&self) noexcept
{
  return self.mType == Type::String;
}

bool
JsonValue::IsNumber(this auto &&self) noexcept
{
  return self.mType == Type::Number;
}

bool
JsonValue::IsArray(this auto &&self) noexcept
{
  return self.mType == Type::Array;
}

bool
JsonValue::IsObject(this auto &&self) noexcept
{
  return self.mType == Type::Object;
}

bool
JsonValue::IsNull(this auto &&self) noexcept
{
  return self.mType == Type::Null;
}
