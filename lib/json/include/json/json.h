...
struct JsonValue
{
  ...
  bool IsBoolean(this auto &&self) noexcept;
  bool IsString(this auto &&self) noexcept;
  bool IsNumber(this auto &&self) noexcept;
  bool IsArray(this auto &&self) noexcept;
  bool IsObject(this auto &&self) noexcept;
  bool IsNull(this auto &&self) noexcept;
