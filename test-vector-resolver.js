registerResolver({ name: 'std::vector', match: 'vector<.*?>' }, function (variable, offset, count) {
  // std::vector in libstdc++ has the structure:
  // struct _Vector_impl {
  ...
  mdb.log(`total size=${totalSize}, trying to return value..`)
