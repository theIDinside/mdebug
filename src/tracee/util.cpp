...
static constexpr std::array<std::pair<u8, u16>, 24> UserRegsMapping = { { { 8, offsetof(user_regs_struct, rax) },
  { 8, offsetof(user_regs_struct, rbx) },
  { 8, offsetof(user_regs_struct, rcx) },
  { 8, offsetof(user_regs_struct, rdx) },
  { 8, offsetof(user_regs_struct, rsi) },
  { 8, offsetof(user_regs_struct, rdi) },
  { 8, offsetof(user_regs_struct, rbp) },
  { 8, offsetof(user_regs_struct, rsp) },
  { 8, offsetof(user_regs_struct, r8) },
  { 8, offsetof(user_regs_struct, r9) },
  { 8, offsetof(user_regs_struct, r10) },
  { 8, offsetof(user_regs_struct, r11) },
  { 8, offsetof(user_regs_struct, r12) },
  { 8, offsetof(user_regs_struct, r13) },
  { 8, offsetof(user_regs_struct, r14) },
  { 8, offsetof(user_regs_struct, r15) },
  { 8, offsetof(user_regs_struct, rip) },
  { 4, offsetof(user_regs_struct, eflags) },
  { 4, offsetof(user_regs_struct, cs) },
  { 4, offsetof(user_regs_struct, ss) },
  { 4, offsetof(user_regs_struct, ds) },
  { 4, offsetof(user_regs_struct, es) },
  { 4, offsetof(user_regs_struct, fs) },
...
std::string
ProcessExecPath(SessionId pid) noexcept
{
  char buf[128];
  char resolved[PATH_MAX];
  auto end = std::format_to(buf, "/proc/{}/exe", pid);
  *end = 0;
