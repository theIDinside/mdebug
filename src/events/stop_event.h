...
#define FOR_EACH_EVENT(EACH_FN)                                                                                   \
  ...
  EACH_FN(libraryEvent,                                                                                           \
    "New libraries was added to the process space",                                                               \
    void,                                                                                                         \
    mdb::TraceeController *,                                                                                      \
    const mdb::Ref<mdb::TaskInfo> &)                                                                              \
  EACH_FN(breakpointHitEvent,                                                                                     \
    "A breakpoint was hit",                                                                                       \
    void,                                                                                                         \
    mdb::TraceeController *,                                                                                      \
    const mdb::Ref<mdb::TaskInfo> &,                                                                              \
    u32)                                                                                                          \
  EACH_FN(syscallEvent,                                                                                           \
    "A syscall event happened",                                                                                   \
    void,                                                                                                         \
    mdb::TraceeController *,                                                                                      \
    const mdb::Ref<mdb::TaskInfo> &,                                                                              \
    int,                                                                                                          \
    bool)                                                                                                         \
  EACH_FN(threadCreated,                                                                                          \
  ...
  EACH_FN(watchpointEvent,                                                                                        \
    "A watch point was triggered",                                                                                \
    void,                                                                                                         \
    mdb::TraceeController *,                                                                                      \
    const mdb::Ref<mdb::TaskInfo> &)                                                                              \
  ...
  EACH_FN(                                                                                                        \
    vForkDone, "A process is done vforking", void, mdb::TraceeController *, const mdb::Ref<mdb::TaskInfo> &)      \
  ...
  EACH_FN(stoppedAll,                                                                                             \
    "All tasks has been stopped by the supervisor",                                                               \
    void,                                                                                                         \
    mdb::TraceeController *,                                                                                      \
    const mdb::Ref<mdb::TaskInfo> &)
...
#define FOR_EACH_EVENT_RESULT(RETURN_KIND)                                                                        \
  ...
  RETURN_KIND(None,                                                                                               \
    "No value returned. Perform default behavior. For events like breakpoint hits, this usually "                 \
