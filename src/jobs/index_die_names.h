...
struct DieMetaData;
class IndexingTask final : public mdb::StandardTask
{
public:
  ...
  static std::vector<std::shared_ptr<StandardTask>> CreateIndexingJobs(
    ObjectFile *obj, std::pmr::memory_resource *taskGroupAllocator);
...
private:
  ...
  sym::PartialCompilationUnitSymbolInfo InitPartialCompilationUnit(
    UnitData *partialCompUnit, const DieMetaData &partialCompUnitDie) noexcept;
